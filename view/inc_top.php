...
<nav class="navbar navbar-expand-lg navbar-light" style="">
  <div class="container ">
    <a class="navbar-brand" href="home.php"><img src="../images/logo.png" width="200px"></a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">      
      <ul class="navbar-nav ml-auto" >
       ...
       <span class="navbar-text ml-2 mb-4">
         <!-- <img alt="" src="../images/ico_zap.png" width="50px"> -->
         <?php
if(strpos($_SERVER['HTTP_USER_AGENT'], 'Android') || strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone')){
   echo '<a href="https://api.whatsapp.com/send?phone=5511994950675&text=DFC%20FERRAMENTAS" target="_blank">';
}else{
   echo '<a href="https://web.whatsapp.com/send?phone=5511994950675&text=DFC%20FERRAMENTAS" target="_blank">';
}
?>
