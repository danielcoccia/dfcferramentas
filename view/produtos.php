...
$produtoLista = $service->getProdutos($_REQUEST);
include_once "inc_top.php"
?>

	<div class="container">
	<div class="row text-center" style="margin:5px "></div>		
			...
			<div class="col-lg-4" style="width:250">
				<div class="rounded m-1" style="border-width:0px; border-style:solid; border-color: #0780a6;">
					<a  href="produtosDetalhe.php?prod_id='.$lista['id'].'"><img src="../images/produtos/'. $lista['foto'].'" width="200px" height="200px" />
						...
						<br><b>'. $lista['nome'].'</b>
						<br><span font-family:Open Sans, Arial, Helvetica, sans-serif">'.$lista['descricao'].'</span>
						<br><button type="button" class="btn btn-info btn-sm m-1">+</button>
					</a>
				</div>
			</div>';
